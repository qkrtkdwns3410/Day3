...
/**
 *packageName    : com.example.day3.SampleMulitiTouch
 * fileName       : ImageDisplayView
 * author         : letscombine
 * date           : 2022-02-28
 * description    :
 * ===========================================================
...
public class ImageDisplayView extends View implements View.OnTouchListener {
			...
			switch (action) {
				  ...
				  case MotionEvent.ACTION_MOVE:
						...
						if (pointerCount == 1) {
							  ...
							  } else if (distance < oldDistance) { // 축소
	  ...
	  private void scaleImage(float inScaleRatio) {
			...
			//postScale > 비트맵 이미지를 확대. 축소가능.. 1; X 축 기준으로 확대하는 비율 2; Y축기준으로 확대하는 비율
			// 3; 4; 확대 or 축소시 기준이 되는 위치가 일반적으로 비트맵 이미지의 중심점을 지정..
